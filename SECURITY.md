...
This project is [low-priority] because it is experimental. In particular, there is no financial
reward for submissions in this tier.

We use <https://g.co/vulnz> for our intake and triage. For valid issues we will do coordination and
disclosure here on GitHub (including using a GitHub Security Advisory when necessary).
