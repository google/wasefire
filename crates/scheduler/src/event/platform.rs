...
#[cfg(all(feature = "board-api-platform-protocol", feature = "applet-api-platform-protocol"))]
pub mod protocol;
...
impl<'a> From<&'a Event> for Key {
    fn from(event: &'a Event) -> Self {
        match *event {
            #[cfg(all(
                feature = "board-api-platform-protocol",
                feature = "applet-api-platform-protocol"
            ))]
